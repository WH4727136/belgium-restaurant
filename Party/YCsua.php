	...
	<div class="tieudetrang">  
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-2"> 
					<h2 class="tieudetrang">SETTING</h2>
				</div>
				<div class="col-sm-5"> 
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-7"> 
					...
					<input type="text" name="Ten" size="20" maxlength="30" value="<?php echo $rows["TenKhachHang"];?>">
					<p>Số điện thoại - Contact number*</p>
					<input type="text" name="SDT" size="20" maxlength="30"value="<?php echo $rows["SDT"];?>">
					<p>Email*</p>
					<input type="text" name="Email" size="20" maxlength="30"value="<?php echo $rows["Email"];?>">
					<p>Chọn địa điểm - Select the venue*</p>
                    <input type="text" name="diadiem" size="20" maxlength="30"value="<?php echo $rows["Diadiem"];?>">
					<p>Ngày đặt bàn - Reserved date:(dd/mm/yyyy)</p>
					<input type="text" name="Ngdb" value="<?php echo $rows["NGdatban"];?>">
					<p>Giờ đến - Expected arrival time*</p>
					<input type="text" name="thoigian" value="<?php echo $rows["ThoiGian"];?>">
					<p>Số lượng khách - Number of guests*</p>
					<input type="text" name="Solg" size=“20” maxlength=“30” value="<?php echo $rows["Soluong"];?>">
					<p>Yêu cầu khác - Special requests*</p>
					<input type="text" name="Khac" size=“20” maxlength=“30” value="<?php echo $rows["Khac"];?>">
