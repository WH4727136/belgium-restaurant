	...
	<div class="tieudetrang">  
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-2"> 
					<h2 class="tieudetrang">CONTACT</h2>
				</div>
				<div class="col-sm-5"> 
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-7"> 
					...
					<input type="text" name="Ten" size="20" maxlength="30">
					<p>Số điện thoại - Contact number*</p>
					<input type="text" name="SDT" size="20" maxlength="30">
					<p>Email*</p>
					<input type="text" name="Email" size="20" maxlength="30">
					<p>Chọn địa điểm - Select the venue*</p>
					<select name="diadiem">
						<optgroup label="Vui lòng chọn địa điểm-Please select the venue*">
							<option>---</option>
							<option value="CAFE">Belgian Café (Võ Văn Tần, Quận 3)</option>
							<option value="GARDEN">Belgian Garden (Thảo Điền, Quận 2)</option>
					</select>
					<p>Ngày đặt bàn - Reserved date:(dd/mm/yyyy)</p>
					<input type="date" name="Ngdb" size="20" maxlength="30">
					<p>Giờ đến - Expected arrival time*</p>
					<select name="thoigian">
						<optgroup label="Vui lòng chọn thời gian-Please select the time*">
							<option>---</option>
					...
					<input type="text" name="Solg" size=“20” maxlength=“30”>
					<p>Yêu cầu khác - Special requests*</p>
					<input type="text" name="Khac" size=“20” maxlength=“30”>
